...
class iPadCalcVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        var FT = UserDefaults.standard.object(forKey: "first") as? String ?? "first"
                    ...
                    if FirstVersionComponent < newBusinessModel {
                        ...
                        Purchases.shared.getCustomerInfo{ (customerInfo, error) in
                            if customerInfo?.entitlements[Costants.entitlementID]?.isActive == true {
                                ...
                                self.performSegue(withIdentifier: "firstTimePay", sender: nil)
                                
                                UserDefaults.standard.setValue("second", forKey: "first")
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if itsMe == "Weight" {
            ...
            KG_Label.adjustsFontSizeToFitWidth = false
        }
        if itsMe == "Area" {
            ...
            areaButton.titleLabel?.adjustsFontSizeToFitWidth = false
            areaButton.titleLabel?.numberOfLines = 1
        }
    ...
    @IBAction func unwindToViewController(segue: UIStoryboardSegue) {
            print("torno indietro al iPadCalcVC")
        }
