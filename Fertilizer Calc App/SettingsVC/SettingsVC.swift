...
//  Fertilizer Calc App
//
//  Created by Alberto Giambone on 23/02/23.
//
...
class SettingsVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        AreaTable.layer.cornerRadius = 15
        
        AreaTable.delegate = self
        AreaTable.dataSource = self
        
        AreaTable.rowHeight = 50
        AreaTable.estimatedRowHeight = 50
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = AreaTable.dequeueReusableCell(withIdentifier: "cell") as! SettingsTableCell
        
        cell.LogoIMG.image = settArray[indexPath.row].Logo
        cell.TextLabel.text = settArray[indexPath.row].SettingsName
        cell.DisclosureIMG.image = settArray[indexPath.row].DisclosureIMG
