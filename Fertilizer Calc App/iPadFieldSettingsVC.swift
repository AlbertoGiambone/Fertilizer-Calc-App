//
//  iPadFieldSettingsVC.swift
//  Fertilizer Calc App
//
//  Created by Alberto Giambone on 22/04/24.
//
...
class iPadFieldSettingsVC: UIViewController {
    ...
    @IBOutlet weak var growing: RoundButton!
    
    @IBOutlet weak var nitrogenLimit: RoundButton!
    
    @IBOutlet weak var phosphorusLimit: RoundButton!
    
    @IBOutlet weak var potassiumLimit: RoundButton!
    
    @IBOutlet weak var magnesiumLimit: RoundButton!
    
    @IBOutlet weak var calciumLimit: RoundButton!
    ...
    @IBAction func growingButtonTapped(_ sender: RoundButton) {
    ...
    @IBAction func nitrogenButtonTapped(_ sender: RoundButton) {
    ...
    @IBAction func phosphorusButtonTaped(_ sender: RoundButton) {
    ...
    @IBAction func potassiumButtontapped(_ sender: RoundButton) {
    ...
    @IBAction func magnesiumLimitTapped(_ sender: RoundButton) {
    ...
    @IBAction func calciumLimitTapped(_ sender: RoundButton) {
